...
begin
    //FrameMensagem1.MostraMensagem(xMsgTipoCONFIRMAÇÃO, 'CONFIRMAÇÃO DE CADASTRO','Deseja realmente criar uma conta?', true);
...
begin
    //FrameMensagem1.MostraMensagem(xMsgTipoSUCESSO, 'LOGADO COM SUCESSO','Suas informações estão correta, será direcionado para tela principal!', true);
...
begin
    FrameMensagem1.MostraMensagem(xMsgTipoNome, 'Necessario preencher todas informações!', true);
end;
