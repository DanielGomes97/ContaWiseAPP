...
type
  TFrameMensagem = class(TFrame)
    ...
    procedure MostraMensagem(TipoJanela, Texto: String; MostraMsg: Boolean);
...
procedure TFrameMensagem.MostraMensagem(TipoJanela, Texto: String; MostraMsg: Boolean);
begin
    visible := MostraMsg;
    if not MostraMsg then exit;
    LblTituloMensagem.Text := 'Mensagem do sistema';//Titulo;
